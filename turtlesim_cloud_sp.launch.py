# ~/fog_ws/src/my_turtlesim_control/launch/turtlesim_sp.launch.py
# nó de controle rodando na vm AWS em São Paulo, Brasil
...
def generate_launch_description():
    ...
    aws_machine = fogros2.AWSCloudInstance(
        region="sa-east-1",  # Região AWS escolhida: São Paulo, Brasil
